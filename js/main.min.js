...
function Maze(element, rowCount, type) {
    ...
    this.walkBacktracking = function() {
        if (this.status === "start") {
            ...
            if (next === false && this.canWalkTo(x, y, "right") !== false && this.chalked(x, y, "right") === false) next = [ x + 1, y ];
            if (next === false && this.canWalkTo(x, y, "up") !== false && this.chalked(x, y, "up") === false) next = [ x, y - 1 ];
            if (next === false && this.canWalkTo(x, y, "left") !== false && this.chalked(x, y, "left") === false) next = [ x - 1, y ];
            if (next === false && this.canWalkTo(x, y, "down") !== false && this.chalked(x, y, "down") === false) next = [ x, y + 1 ];
            if (next !== false) {
                string = true;
            } else {
                if (next === false && this.canWalkTo(x, y, "right") !== false && this.stringed(x, y, "right") === true) next = [ x + 1, y ];
                if (next === false && this.canWalkTo(x, y, "up") !== false && this.stringed(x, y, "up") === true) next = [ x, y - 1 ];
                if (next === false && this.canWalkTo(x, y, "left") !== false && this.stringed(x, y, "left") === true) next = [ x - 1, y ];
                if (next === false && this.canWalkTo(x, y, "down") !== false && this.stringed(x, y, "down") === true) next = [ x, y + 1 ];
                if (next === false) {
                    if (next === false && this.canWalkTo(x, y, "right") !== false) next = [ x + 1, y ];
                    if (next === false && this.canWalkTo(x, y, "up") !== false) next = [ x, y - 1 ];
                    if (next === false && this.canWalkTo(x, y, "left") !== false) next = [ x - 1, y ];
                    if (next === false && this.canWalkTo(x, y, "down") !== false) next = [ x, y + 1 ];
                    if (next !== false) {
                        string = true;
                    }
                }
